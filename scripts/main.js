document.addEventListener('DOMContentLoaded', () => {
  ...
  async function fetchGitHubStats() {
    try {
      // Fetch stats generated by GitHub Actions
      ...
      if (commitsEl) animateCount(commitsEl, stats.commits || 0);
      if (linesEl) animateCount(linesEl, stats.lines || 0);
      if (prsEl) animateCount(prsEl, stats.prs || 0);
    } catch (err) {
